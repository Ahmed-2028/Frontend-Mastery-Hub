...
> Status: **Completed** ✅
* 📜 **Concept (Detailed Curriculum):**
  1. **Displaying in the Console:** We use `console.log()` to display data and test code within the console.
  2. **Arithmetic Methods:** JavaScript can perform calculations such as Addition (+), Subtraction (-), Multiplication (*), and Division (/).
  3. **Concatenation [1]:** Joining two strings together is called concatenation.
...
> Status: **Completed** ✅
* 📜 **Concept (Detailed Curriculum):**
  1. **Declarations & Assignments:** Declaration is creating the variable, and assignment is giving it a value using the `=` sign.
  2. **Variables (let):** We use the keyword `let` to define variables that allow us to change their value later.
...
*
* 🔗 **Source Code:** [Link to Demo Explanation 1](Mini-Project-01/Daily-Tasks/JAVASCRIPT/task4.js
)
